...
// MENGGUNAKAN SDK REALTIME DATABASE (Bukan Firestore lagi)
...
const firebaseConfig = {
  ...
  databaseURL: "https://jadiin-project-f6d1b-default-rtdb.asia-southeast1.firebasedatabase.app/", // Menggunakan URL ini
...
const db = getDatabase(app); // Menggunakan getDatabase murni
...
if (document.getElementById('btnSaveInfo')) {
    ...
    document.getElementById('btnSaveInfo').onclick = async () => {
        try {
            ...
            alert("UPDATE REALTIME DATABASE BERHASIL!");
